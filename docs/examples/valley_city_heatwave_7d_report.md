# AquaOS run report: valley_city_heatwave_7d
...
- Scenario hash: `f93d4bff854fe82cfcfd5d79abed410b299e3b7cd2f97c17f26f131e1c3dc58d`
...
- Description: Baseline week plus a SYNTHETIC 4-day heat wave (+4 degC peak, +5 degC overnight), CY2026 Tier 1.

## Key results

| KPI | Value |
|---|---|
| Water delivered | 242,245 m³ (196.4 af; avg 9.14 MGD) |
| Pumping energy | 96,853 kWh |
| Energy intensity | 0.400 kWh/m³ delivered |
| Peak pumping demand | 836 kW |
...
| Mass-balance closure error | -0.038% |
...
- Treatment plant setting 0.300 m³/s. CAP water treated this run 139.9 af vs a monthly-shaped pro-rata share of 149.6 af.
- Groundwater (phoenix AMA label): pumped 19.4 af. Remaining annual allowance 1,200.0 af; pro-rata for this run 48.8 af.
...
- Maximum well drawdown (Theis, with interference): 5.23 m. Pumped volume changed 0.08% in the last drawdown iteration.
...
|---|---|---|---|---|---|---|---|---|
| 1 | 74 | 42.7 | 48.2 | 64.7 | 87.5 | 0.0 | 0.0 | 0.0 |
| 2 | 75 | 46.1 | 50.2 | 67.6 | 87.6 | 0.0 | 0.0 | 0.0 |
| 3 | 74 | 47.4 | 50.0 | 66.5 | 85.1 | 0.0 | 0.0 | 0.0 |
| 4 | 72 | 47.4 | 50.9 | 66.5 | 85.3 | 0.0 | 0.0 | 0.0 |
...
|---|---|---|---|---|---|---|---|---|
| T1 | 3.99 | 6.50 | 6.50 | 4.30 | 1.00 | 10.00 | 0.00 | 0.00 |
| T2 | 4.44 | 7.51 | 6.50 | 5.00 | 1.00 | 10.00 | 0.00 | 0.00 |
| T3 | 4.51 | 8.05 | 6.50 | 5.36 | 1.00 | 10.00 | 0.00 | 0.00 |
| T4 | 4.31 | 8.75 | 6.50 | 6.79 | 1.00 | 10.00 | 0.00 | 0.00 |
| CLEARWELL | 1.97 | 5.20 | 3.50 | 3.33 | 0.50 | 5.50 | 0.00 | 0.00 |
| RCL_TANK | 4.00 | 6.99 | 4.50 | 6.00 | 1.00 | 8.00 | 0.00 | 0.00 |

## Pump energy

| pump | kind | kwh | volume_m3 | kwh_per_m3 | peak_kw | run_hours |
|---|---|---|---|---|---|---|
| HS1 | high_service | 23261.89 | 131828.69 | 0.18 | 142.20 | 164.50 |
| HS2 | high_service | 7794.79 | 40939.10 | 0.19 | 141.79 | 55.50 |
| B2_1 | booster | 14180.05 | 123209.88 | 0.12 | 86.22 | 164.75 |
| B2_2 | booster | 0.00 | 0.00 | nan | 0.00 | 0.00 |
| B3_1 | booster | 8873.09 | 89408.89 | 0.10 | 54.60 | 165.00 |
| B3_2 | booster | 0.00 | 0.00 | nan | 0.00 | 0.00 |
| B4_1 | booster | 4386.33 | 46006.96 | 0.10 | 26.89 | 165.25 |
| B4_2 | booster | 0.00 | 0.00 | nan | 0.00 | 0.00 |
| GW2_1 | well | 17885.00 | 21518.75 | 0.83 | 124.96 | 144.50 |
| GW2_2 | well | 0.00 | 0.00 | nan | 0.00 | 0.00 |
| GW2_3 | well | 0.00 | 0.00 | nan | 0.00 | 0.00 |
| GW3_1 | well | 2265.80 | 2452.42 | 0.92 | 140.33 | 16.25 |
| GW3_2 | well | 0.00 | 0.00 | nan | 0.00 | 0.00 |
| RW1 | recovery_well | 14070.50 | 21603.69 | 0.65 | 87.92 | 161.25 |
| RW2 | recovery_well | 0.00 | 0.00 | nan | 0.00 | 0.00 |
| RCL_P1 | reclaimed | 4135.53 | 20530.83 | 0.20 | 36.47 | 114.50 |
...
- Maximum instantaneous continuity residual: 1.38e-06 m³/s (2.40e-06 of peak demand).
- Sources 238,636 m³ = demand 242,245 m³ + storage change -3,518 m³ (closure error -0.038%).
- Tank volume consistency (level-derived vs integrated inflow, relative to throughput): T1 0.07%, T2 0.07%, T3 0.33%, T4 0.33%, CLEARWELL 0.23%, RCL_TANK 0.04%. At 15-minute reporting, pump switches between report steps are not sampled; errors of a few percent are resolution effects (they vanish at 5-minute steps).
